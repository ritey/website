...
<div class="container mx-auto">
    ...
    <div class="">
        ...
        <div class="w-full md:w-1/2 mx-auto text-center">
            ...
            <ul class="mt-0 mb-4 leading-6 text-left text-neutral-800">
                <li class="leading-6 text-left text-neutral-800">Lead developer building <a href="https://idea.org.uk" target="_blank">iDEA.org.uk</a></li>
                <li class="leading-6 text-left text-neutral-800">Laravel package project CSCMS, a starter composer package for a basic Laravel content management system. Currently in early development.  <br /><a href="https://github.com/coderstudios/cscms" target="_blank">View the Github repo</a></li>
            </ul>
